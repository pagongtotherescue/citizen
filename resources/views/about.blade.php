...
<main>
    ...
    <div class="container mx-auto px-6 py-16 text-center">
        ...
        <h1 class="text-3xl font-bold text-gray-800 lg:text-4xl">Building Your Next App with our Awesome components</h1>
    ...
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 lg:text-4xl">Portfolio</h1>

        <p class="mt-4 text-center text-gray-500">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus</p>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-gray-800">Best website collections</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-500">Website</p>
        </div>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-gray-800">Block of Ui kit collections</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-500">Ui kit</p>
        </div>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-gray-800">Ton’s of mobile mockup</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-500">Mockups</p>
        </div>
        </div>
    </div>
    </section>
    ...
    <div class="h-[32rem] bg-gray-100">
        <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 lg:text-4xl">The Executive Team</h1>
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo incidunt ex placeat modi magni quia error alias, adipisci rem similique, at omnis eligendi optio eos harum.</p>
        </div>
    </div>
    ...
    <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700">arthur melo</h1>

            <p class="mt-2 capitalize text-gray-500">design director</p>
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700">Pamela Anderson</h1>

            <p class="mt-2 capitalize text-gray-500">Lead Developer</p>
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700">John Doe</h1>

            <p class="mt-2 capitalize text-gray-500">Full stack developer</p>
    ...
    <section class="bg-white">
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 lg:text-4xl">What clients saying</h1>
        ...
        <button class="hidden rounded-full border p-2 text-gray-800 transition-colors duration-300 hover:bg-gray-100 rtl:-scale-x-100 lg:block">
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <h1 class="text-3xl font-semibold capitalize text-gray-800 lg:text-4xl">From the blog</h1>
        ...
        <div>
            ...
            <div class="absolute bottom-0 flex bg-white p-3">
            ...
            <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis fugit dolorum amet dolores praesentium, alias nam? Tempore</p>
    ...
    <div class="container mx-auto px-6 py-8">
        <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 lg:text-4xl">Pricing Plan</h1>

        <p class="mx-auto mt-4 max-w-2xl text-center text-gray-500 xl:mt-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias quas magni libero consequuntur voluptatum velit amet id repudiandae ea, deleniti laborum in neque eveniet.</p>

        <div class="mt-6 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:mt-12 xl:gap-12">
        <div class="w-full space-y-8 rounded-lg border border-gray-100 p-8 text-center">
            <p class="font-medium uppercase text-gray-500">Free</p>

            <h2 class="text-5xl font-bold uppercase text-gray-800">$0</h2>
        ...
        <div class="w-full space-y-8 rounded-lg bg-blue-600 p-8 text-center">
            ...
            <h2 class="text-5xl font-bold uppercase text-white">$40</h2>
        ...
        <div class="w-full space-y-8 rounded-lg border border-gray-100 p-8 text-center">
            <p class="font-medium uppercase text-gray-500">Enterprise</p>

            <h2 class="text-5xl font-bold uppercase text-gray-800">$100</h2>
    ...
    <div class="container mx-auto max-w-4xl px-6 py-10">
        <h1 class="text-center text-4xl font-semibold text-gray-800">Frequently asked questions</h1>
        ...
        <div class="rounded-lg border-2 border-gray-100">
            ...
            <p class="p-8 text-sm text-gray-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas eaque nobis, fugit odit omnis fugiat deleniti animi ab maxime cum laboriosam recusandae facere dolorum veniam quia pariatur obcaecati illo ducimus?</p>
        </div>

        <div class="rounded-lg border-2 border-gray-100">
            <button class="flex w-full items-center justify-between p-8">
            <h1 class="font-semibold text-gray-700">Is the cost of the appoinment covered by private health insurance?</h1>
    ...
    <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
        ...
        <div class="mt-8 lg:mx-6 lg:w-1/2">
            ...
            <h1 class="text-2xl font-medium text-gray-700">Contact form</h1>

            <form class="mt-6">
                <div class="flex-1">
                <label class="mb-2 block text-sm text-gray-600">Full Name</label>
                <input type="text" placeholder="John Doe" class="mt-2 block w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
                </div>

                <div class="mt-6 flex-1">
                <label class="mb-2 block text-sm text-gray-600">Email address</label>
                <input type="email" placeholder="johndoe@example.com" class="mt-2 block w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" />
                </div>

                <div class="mt-6 w-full">
                <label class="mb-2 block text-sm text-gray-600">Message</label>
                <textarea class="mt-2 block h-32 w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 md:h-48" placeholder="Message"></textarea>
                </div>
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <h1 class="text-3xl font-semibold tracking-tight text-gray-800 md:mx-3 xl:text-4xl">Subscribe our newsletter to get update.</h1>
        ...
        <div>
            ...
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Home</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Who We Are</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Our Philosophy</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-5 flex flex-col items-start space-y-2">
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Retail & E-Commerce</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Information Technology</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Finance & Insurance</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-5 flex flex-col items-start space-y-2">
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Translation</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Proofreading & Editing</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">Content Creation</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-5 flex flex-col items-start space-y-2">
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">+880 768 473 4978</a>
            <a href="#" class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline">info@merakiui.com</a>
            </div>
        </div>
        </div>
        ...
        <a href="#" class="text-2xl font-bold text-gray-800 transition-colors duration-300 hover:text-gray-700">Brand</a>

        <p class="mt-4 text-sm text-gray-500 sm:mt-0">© Copyright 2021. All Rights Reserved.</p>
        </div>
    </div>
    </footer>
</main>
