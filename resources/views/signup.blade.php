            ...
            <div class="w-full">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-3 md:flex md:items-center md:-mx-2">
                        ...
                        <a href="/adminsignup" button class="flex justify-center w-full px-6 py-3 mt-4 text-blue-500 border border-blue-500 rounded-md md:mt-0 md:w-auto md:mx-2 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<!-- SIGN UP FORM -->
                <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" method="POST" action="/signup">
                    @csrf
                <div>
                        <label class="block mb-2 text-sm text-gray-600">{{ __('Name') }}</label>
                        <input type="text" name="name" placeholder="John Snow" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>

                    <div>
                        <label class="block mb-2 text-sm text-gray-600">{{ __('Email') }}</label>
                        <input type="email" name="email" placeholder="johnsnow@example.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
